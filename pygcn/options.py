...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', type=str, default='../data/Planetoid', help='path')
        self.parser.add_argument('--dataset', type=str, default='cora', help='[cora | citeseer | pubmed]')
        self.parser.add_argument('--num_hidden', type=int, default=50, help='number of features')
        self.parser.add_argument('--dropout', type=float, default=0.75, help='dropout')
        self.parser.add_argument('--weight_decay', type=float, default=5e-4, help='weight decay')
        self.parser.add_argument('--init_type', type=str, default='xavier', help='[uniform | xavier | kaiming]')
        self.parser.add_argument('--model', type=str, default='GCN', help='[GCN | GAT]')
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--epoch', type=int, default=1000, help='number of training epochs')
